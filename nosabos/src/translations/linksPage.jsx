...
export const linksPageTranslations = {
  en: {
    ...
    rbeReadyToSignIn: "You are ready to sign in.",
  ...
  it: {
    ...
    rbeReadyToSignIn: "Ora puoi accedere.",
  ...
  es: {
    ...
    rbeReadyToSignIn: "Ya puedes iniciar sesión.",
...
linksPageTranslations.ar = {
  ...
  rbeReadyToSignIn: "أنت جاهز لتسجيل الدخول.",
...
linksPageTranslations.fr = {
  ...
  rbeReadyToSignIn: "Tu peux maintenant te connecter.",
...
linksPageTranslations.ja = {
  ...
  rbeReadyToSignIn: "ログインの準備ができました。",
...
linksPageTranslations.de = {
  ...
  rbeReadyToSignIn: "Du kannst dich jetzt anmelden.",
