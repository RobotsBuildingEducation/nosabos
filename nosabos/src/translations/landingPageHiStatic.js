export const LANDING_PAGE_HI_STATIC = {
  nav_signin: "साइन इन",
  hero_title: "आपके लिए",
  hero_title_accent: "व्यक्तिगत भाषा शिक्षक",
  hero_subtitle:
  ...
  languages_title_accent: "12 भाषाओं में",
  languages_stable: "स्थिर",
  languages_beta: "बीटा",
  languages_alpha: "अल्फ़ा",
  ...
  feature_memory_desc:
    "आपकी गलतियों, लक्ष्यों और प्रगति को याद रखकर उन्हें केंद्रित समीक्षा में बदलता है।",
  feature_journey: "सफ़र",
  feature_journey_desc:
    "मुख्य पड़ावों पर वॉयस नोट्स सहेजें ताकि समय के साथ अपने बोलने की प्रगति को सुन सकें।",
  ...
  feature_reading: "रीडिंग अभ्यास",
  feature_reading_desc:
    "विषय-आधारित पाठ जो समझ अभ्यास के साथ आपकी शब्दावली और सांस्कृतिक समझ बढ़ाते हैं।",
  ...
  feature_flashcards_desc:
    "अपने स्तर और आम परिस्थितियों के आधार पर नए शब्दों का अभ्यास करें।",
  feature_goals: "दैनिक लक्ष्य",
  feature_goals_desc:
    "व्यक्तिगत लक्ष्य जो आपकी प्रगति को ट्रैक करते हैं और निरंतरता का उत्सव मनाते हैं।",
  ...
  feature_flashcards_spaced: "फ्लैशकार्ड ड्रिल्स",
  feature_flashcards_spaced_desc:
    "शुरुआती से उन्नत CEFR स्तरों तक व्यवस्थित अंतराल-पुनरावृत्ति फ्लैशकार्ड के साथ 1,000+ शब्द और वाक्यांश सीखें।",
  feature_game_review: "गेम रिव्यू RPG",
  feature_game_review_desc:
    "क्वेस्ट-आधारित दुनिया खोजें, NPCs से बात करें और वस्तुएं इकट्ठा करें—सब कुछ आपकी लक्ष्य भाषा में—ताकि अपने पाठों की शब्दावली दोहरा सकें।",
  feature_proficiency_test: "प्रवीणता परीक्षण",
  feature_proficiency_test_desc:
    "AI के साथ 10-टर्न की वॉइस बातचीत करें जो रीयल-टाइम में अनुकूलित होकर आपको सही CEFR स्तर पर रखती है।",
  ...
  value_1:
    "AI जो रीयल-टाइम में अनुकूलित होता है—बातचीत, अभ्यास और फीडबैक आपके सटीक स्तर के अनुसार बदलते हैं",
  value_2:
    "हर सीखने की शैली के लिए छह अभ्यास मोड: बोलना, पढ़ना, लिखना, सुनना, व्याकरण और शब्दावली",
  value_3:
    "A1 शुरुआती से C2 महारत तक 324 पाठों और स्पष्ट मील के पत्थरों के साथ संरचित CEFR प्रगति",
  value_4:
  ...
  faq_a1:
    "हम एक सुरक्षित कुंजी बनाते हैं जो आपके व्यक्तिगत अध्ययन स्थान को खोलती है। इसे सुरक्षित रखें—दूसरे डिवाइस से साइन इन करने का यही एकमात्र तरीका है।",
  faq_q2: "क्या मुझे blockchain या Nostr के बारे में कुछ जानना ज़रूरी है?",
  faq_a2:
    "नहीं। हम आपके लिए तकनीकी विवरण संभालते हैं। पाठों में वापस आने के लिए आपको केवल अपनी कुंजी चाहिए।",
  faq_q3: "मैं किन भाषाओं का अभ्यास कर सकता हूँ?",
  faq_a3:
    "आप ऊपर दी गई किसी भी भाषा का अभ्यास कर सकते हैं। हम समय के साथ और भाषाएँ जोड़ते रहेंगे।",
...
export default LANDING_PAGE_HI_STATIC;
