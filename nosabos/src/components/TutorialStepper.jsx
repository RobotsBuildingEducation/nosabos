...
const MODULE_CONFIG = {
  vocabulary: {
    icon: RiBook2Line,
    color: "#10B981",
    label: { en: "Vocabulary", es: "Vocabulario", it: "Vocabolario", fr: "Vocabulaire", ja: "語彙" },
    shortLabel: { en: "Vocab", es: "Vocab", it: "Vocab", fr: "Vocab", ja: "語彙" },
    description: {
  ...
  grammar: {
    icon: RiPencilLine,
    color: "#3B82F6",
    label: { en: "Grammar", es: "Gramática", it: "Grammatica", fr: "Grammaire", ja: "文法" },
    shortLabel: { en: "Grammar", es: "Gram", it: "Gram", fr: "Gram", ja: "文法" },
    description: {
  ...
  reading: {
    icon: FaBookOpen,
    color: "#F59E0B",
    label: { en: "Reading", es: "Lectura", it: "Lettura", fr: "Lecture", ja: "読解" },
    shortLabel: { en: "Read", es: "Leer", it: "Leggi", fr: "Lire", ja: "読む" },
    description: {
  ...
  stories: {
    ...
    color: "#EC4899",
    label: { en: "Stories", es: "Historias", it: "Storie", fr: "Histoires", ja: "ストーリー" },
    shortLabel: { en: "Story", es: "Historia", it: "Storia", fr: "Histoire", ja: "物語" },
    description: {
  ...
  realtime: {
    icon: FaMicrophone,
    color: "#8B5CF6",
    label: { en: "Chat", es: "Chat", it: "Chat", fr: "Chat", ja: "チャット" },
    shortLabel: { en: "Chat", es: "Hablar", it: "Parla", fr: "Parler", ja: "話す" },
    description: {
  ...
  game: {
    icon: FaGamepad,
    color: "#F97316",
    label: { en: "Game", es: "Juego", it: "Gioco", fr: "Jeu", ja: "ゲーム" },
    shortLabel: { en: "Game", es: "Juego", it: "Gioco", fr: "Jeu", ja: "ゲーム" },
    description: {
