...
const MODULE_CONFIG = {
  vocabulary: {
    icon: RiBook2Line,
    color: "#10B981",
    label: { en: "Vocabulary", es: "Vocabulario", it: "Vocabolario" },
    shortLabel: { en: "Vocab", es: "Vocab", it: "Vocab" },
    description: {
  ...
  grammar: {
    icon: RiPencilLine,
    color: "#3B82F6",
    label: { en: "Grammar", es: "Gramática", it: "Grammatica" },
    shortLabel: { en: "Grammar", es: "Gram", it: "Gram" },
    description: {
  ...
  reading: {
    icon: FaBookOpen,
    color: "#F59E0B",
    label: { en: "Reading", es: "Lectura", it: "Lettura" },
    shortLabel: { en: "Read", es: "Leer", it: "Leggi" },
    description: {
  ...
  stories: {
    ...
    color: "#EC4899",
    label: { en: "Stories", es: "Historias", it: "Storie" },
    shortLabel: { en: "Story", es: "Historia", it: "Storia" },
    description: {
  ...
  realtime: {
    icon: FaMicrophone,
    color: "#8B5CF6",
    label: { en: "Chat", es: "Chat", it: "Chat" },
    shortLabel: { en: "Chat", es: "Hablar", it: "Parla" },
    description: {
  ...
  game: {
    icon: FaGamepad,
    color: "#F97316",
    label: { en: "Game", es: "Juego", it: "Gioco" },
    shortLabel: { en: "Game", es: "Juego", it: "Gioco" },
    description: {
