...
const MODULE_CONFIG = {
  vocabulary: {
    icon: RiBook2Line,
    color: "#10B981",
    label: { en: "Vocabulary", es: "Vocabulario", it: "Vocabolario", fr: "Vocabulaire" },
    shortLabel: { en: "Vocab", es: "Vocab", it: "Vocab", fr: "Vocab" },
    description: {
  ...
  grammar: {
    icon: RiPencilLine,
    color: "#3B82F6",
    label: { en: "Grammar", es: "Gramática", it: "Grammatica", fr: "Grammaire" },
    shortLabel: { en: "Grammar", es: "Gram", it: "Gram", fr: "Gram" },
    description: {
  ...
  reading: {
    icon: FaBookOpen,
    color: "#F59E0B",
    label: { en: "Reading", es: "Lectura", it: "Lettura", fr: "Lecture" },
    shortLabel: { en: "Read", es: "Leer", it: "Leggi", fr: "Lire" },
    description: {
  ...
  stories: {
    ...
    color: "#EC4899",
    label: { en: "Stories", es: "Historias", it: "Storie", fr: "Histoires" },
    shortLabel: { en: "Story", es: "Historia", it: "Storia", fr: "Histoire" },
    description: {
  ...
  realtime: {
    icon: FaMicrophone,
    color: "#8B5CF6",
    label: { en: "Chat", es: "Chat", it: "Chat", fr: "Chat" },
    shortLabel: { en: "Chat", es: "Hablar", it: "Parla", fr: "Parler" },
    description: {
  ...
  game: {
    icon: FaGamepad,
    color: "#F97316",
    label: { en: "Game", es: "Juego", it: "Gioco", fr: "Jeu" },
    shortLabel: { en: "Game", es: "Juego", it: "Gioco", fr: "Jeu" },
    description: {
