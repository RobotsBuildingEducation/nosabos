...
export const WORLD_BLUEPRINTS = [
  {
    ...
    gatherTheme: "home",
    tileTheme: {
      groundColors: [[0xd69a58, 0xc2854a, 0xe2aa68]],
      groundDetail: "wood_floor",
      pathColors: [[0xc75b45, 0xb04a3a]],
      pathDetail: "rug",
      wallColors: [[0xe8d4b0, 0xd9bf94]],
      blockColors: [[0xa5754b, 0x8f6239]],
      blockDetail: "wall",
      accentColors: [[0x53948c, 0x477f78]],
      accentDetail: "rug",
      objectColors: [[0x8a6136, 0x74502c]],
  ...
  },
  {
    ...
    gatherTheme: "market",
    tileTheme: {
      groundColors: [[0xefdcb2, 0xe4cd9c]],
      groundDetail: "tile_floor",
      pathColors: [[0xc98d4f, 0xb87e43]],
      pathDetail: "mat",
      wallColors: [[0xf6e6c8, 0xead5ae]],
      blockColors: [[0xa06c3c, 0x8a5a32]],
      blockDetail: "wall",
      accentColors: [[0xd8622f, 0xeaa254]],
      accentDetail: "produce",
      objectColors: [[0x94672e, 0x7c5527]],
      objectDetail: "wood_floor",
    },
  },
  {
    ...
    gatherTheme: "library",
    tileTheme: {
      groundColors: [[0xc78e52, 0xb37a42, 0xd49f63]],
      groundDetail: "wood_floor",
      pathColors: [[0x9e4040, 0x832f39]],
      pathDetail: "rug",
      wallColors: [[0xe4d5b8, 0xd4c29e]],
      blockColors: [[0x74512e, 0x876240]],
      blockDetail: "wall",
      accentColors: [[0xdec48c, 0xd0ac66]],
      accentDetail: "rug",
      objectColors: [[0x805d36, 0x6a4a26]],
      objectDetail: "wood_floor",
    },
  },
  {
    ...
    gatherTheme: "transit",
    tileTheme: {
      groundColors: [[0xe2e8ee, 0xd4dde6]],
      groundDetail: "tile_floor",
      pathColors: [[0x50688e, 0x44597c]],
      pathDetail: "runway",
      wallColors: [[0xb9c5d1, 0xa7b6c4]],
      blockColors: [[0x8194a8, 0x6e8296]],
      blockDetail: "wall",
      accentColors: [[0xf3f7fb, 0xe4edf5]],
      accentDetail: "linoleum",
      objectColors: [[0x90a4b6, 0x7890a0]],
  ...
  },
  {
    ...
    gatherTheme: "nature",
    tileTheme: {
      groundColors: [[0x4a9c30, 0x58ab3a, 0x69ba4a]],
      groundDetail: "grass",
      pathColors: [[0xdca763, 0xcf9754]],
      pathDetail: "dirt",
      wallColors: [[0x86694a, 0x715741]],
      blockColors: [[0x2f7a22, 0x3d8c2c]],
      blockDetail: "grass",
      accentColors: [[0x54a637, 0x66b849]],
      accentDetail: "flower",
      objectColors: [[0x5d8140, 0x4c6c34]],
      objectDetail: "grass",
    },
  },
  {
    ...
    gatherTheme: "civic",
    tileTheme: {
      groundColors: [[0xe3dac4, 0xd6cab0]],
      groundDetail: "tile_floor",
      pathColors: [[0xb3a68a, 0xa29477]],
      pathDetail: "gravel",
      wallColors: [[0xc4bba8, 0xb1a691]],
      blockColors: [[0x91876f, 0x7c7260]],
      blockDetail: "wall",
      accentColors: [[0x7b91a6, 0x8fa5ba]],
      accentDetail: "linoleum",
      objectColors: [[0x7a6c56, 0x655843]],
      objectDetail: "wood_floor",
    },
  },
  {
    ...
    gatherTheme: "lab",
    tileTheme: {
      groundColors: [[0xecf3f4, 0xdfe9ec]],
      groundDetail: "linoleum",
      pathColors: [[0xaac6d8, 0x98b7cb]],
      pathDetail: "tile_floor",
      wallColors: [[0xc6d5de, 0xb5c6d1]],
      blockColors: [[0x92a9bc, 0x7d95a8]],
      blockDetail: "wall",
      accentColors: [[0xc4eef2, 0xafe1e8]],
      accentDetail: "linoleum",
      objectColors: [[0x95a8b2, 0x7d919b]],
      objectDetail: "tile_floor",
    },
  },
  {
    ...
    tileTheme: {
      groundColors: [[0xe6cc8f, 0xdbbf7e]],
      groundDetail: "gravel",
      pathColors: [[0xda574a, 0xeb8f5e]],
      pathDetail: "mat",
      wallColors: [[0xba97ae, 0xa7839b]],
      blockColors: [[0x87617c, 0x724f68]],
      blockDetail: "wall",
      accentColors: [[0xffd166, 0xff8fab, 0x7dd3fc]],
      accentDetail: "flower",
      objectColors: [[0x967650, 0x7d6140]],
      objectDetail: "wood_floor",
    },
  },
];
...
const WORLD_BLUEPRINTS_HI = [
  {
    names: ["आरामदायक बैठक", "पारिवारिक अपार्टमेंट", "मोहल्ले का घर"],
    summary: "रोजमर्रा की चीज़ों और घरेलू बारीकियों से भरा एक गर्मजोशी वाला घर",
  },
  {
    names: ["चहल-पहल वाला भोजन कक्ष", "मोहल्ले की रसोई", "बाज़ार कैफ़े"],
    summary: "काउंटरों, उपकरणों और काम की चीज़ों वाला एक जीवंत भोजन स्थल",
  },
  {
    names: ["शांत पुस्तकालय कक्ष", "पठन कक्ष", "लेखकों का अभिलेखागार"],
    summary: "शेल्फ़, मेज़ और पढ़ने के कोनों वाला किताबों से भरा अध्ययन स्थल",
  },
  {
    names: ["अंतरराष्ट्रीय टर्मिनल", "ट्रांज़िट कॉनकोर्स", "यात्रा केंद्र"],
    summary: "गेट, संकेतों और प्रतीक्षा क्षेत्रों वाला एक अंतरराष्ट्रीय यात्रा स्थल",
  },
  {
    names: ["वन पथ", "उद्यान पथ", "पार्क का खुला मैदान"],
    summary: "मुड़ते रास्तों, हरियाली और निशानों वाला खुला प्राकृतिक इलाका",
  },
  {
    names: ["नागरिक सभा कक्ष", "सम्मेलन एट्रियम", "सार्वजनिक मंच"],
    summary: "मेज़ों, संकेतों और औपचारिक मुलाक़ात स्थलों वाला एक सुसज्जित सार्वजनिक स्थान",
  },
  {
    names: ["अनुसंधान प्रयोगशाला", "नवाचार स्टूडियो", "विज्ञान कार्यशाला"],
    summary: "उपकरणों, भंडारण और अध्ययन स्टेशनों वाला साफ़ तकनीकी स्थान",
  },
  {
    names: ["उत्सव चौक", "जश्न टैरेस", "सड़क उत्सव"],
    summary: "ध्वनि, सजावट और उत्सवी ऊर्जा से भरा रंगीन सामाजिक स्थान",
  },
];

WORLD_BLUEPRINTS.forEach((blueprint, index) => {
  const hi = WORLD_BLUEPRINTS_HI[index];
  if (!hi) return;
  blueprint.names.hi = blueprint.names.hi || hi.names;
