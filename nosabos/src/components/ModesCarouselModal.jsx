...
const buildSlides = (includePhonics) => [
  {
    ...
    description: {
      en: "Finish tasks using different learning modes to earn bonus XP for completing today’s focus.",
      es: "Completa tareas usando distintos modos de aprendizaje y gana XP extra al terminar el enfoque de hoy.",
      pt: "Conclua tarefas usando diferentes modos de aprendizado e ganhe XP bônus ao completar o foco de hoje.",
      it: "Completa attività usando diversi modi di apprendimento e guadagna XP bonus completando il focus di oggi.",
      fr: "Termine des tâches avec différents modes d'apprentissage et gagne un bonus d'XP en complétant le focus du jour.",
      de: "Erledige Aufgaben mit verschiedenen Lernmodi und verdiene Bonus-XP, wenn du den heutigen Fokus abschließt.",
      ja: "さまざまな学習モードでタスクをこなし、今日のフォーカスを達成してボーナスXPを獲得しましょう。",
      hi: "अलग-अलग लर्निंग मोड से कार्य पूरे करें और आज का फ़ोकस पूरा करने पर बोनस XP कमाएँ।",
      ar: "أكمل المهام باستخدام أوضاع تعلّم مختلفة واحصل على نقاط XP إضافية عند إتمام تركيز اليوم.",
      zh: "使用不同的学习模式完成任务，完成今日重点即可获得额外经验值。",
    },
  },
  {
    id: "path",
