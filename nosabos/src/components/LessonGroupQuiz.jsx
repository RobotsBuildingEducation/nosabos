...
const LESSON_QUIZ_UI = {
  ...
  de: {
    listenQuestion: "Frage anhören",
    quizPassedToast: "Quiz bestanden!",
    quizPassed: "Quiz bestanden! 🎉",
    quizFailed: "Quiz nicht bestanden 😔",
    score: "Punktzahl",
    passedDesc: (correct, xp) =>
      `Glückwunsch! Du hast mit ${correct} richtigen Antworten bestanden und ${xp} XP verdient!`,
    failedDesc: (needed, correct) =>
      `Du brauchst ${needed} richtige Antworten zum Bestehen. Du hast ${correct}. Versuch es noch einmal!`,
    ...
    matchWords: "Ordne die Wörter den Definitionen zu",
    clickDefinitions: "(Klicke auf Definitionen, um sie zuzuordnen)",
    unknownQuestionType: "Unbekannter Fragetyp",
