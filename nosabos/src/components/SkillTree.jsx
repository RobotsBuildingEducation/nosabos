...
const LESSON_TITLE_ICONS = {
  // Pre-A1 - Foundations
  "My Family": RiTeamLine,
  "More Family": RiParentLine,
  "People Around Me": RiGroupLine,
  "Zero to Five": RiNumbersLine,
  "Six to Ten": RiBarChartLine,
  "Counting Objects": RiTodoLine,
  "Saying Hello": RiHandHeartLine,
  "Saying Goodbye": RiUserSmileLine,
  "Greetings in Context": RiChatSmileLine,
  "Yes and No": RiCheckboxCircleLine,
  "Maybe and I Don't Know": RiQuestionLine,
  "Quick Responses": RiMessageLine,
  "Please and Thank You": RiHeart3Line,
  "Sorry and Excuse Me": RiUserHeartLine,
  "Polite Expressions": RiChatQuoteLine,
  "Things at Home": RiHome4Line,
  "Personal Items": RiShoppingBag3Line,
  "Food and Drink": RiRestaurant2Line,
  "Primary Colors": RiPaletteLine,
  "More Colors": RiContrastLine,
  "Black, White & Neutral": RiDropLine,
  "Saying Your Name": RiAccountCircleLine,
  "Asking Names": RiQuestionAnswerLine,
  "Everyday Starters": RiSparklingLine,
  "People & Places": RiMapPinLine,
  "Actions & Essentials": RiPlayListAddLine,
  "Time, Travel & Directions": RiCompassLine,
...
function LessonNode({
  ...
  const lightNodeColorEnd = shouldPastelizeNode
    ? mixHexColors(unit.color, "#f2e6d4", 0.18)
    : unit.color;
  const lightNodeGlowColor = shouldPastelizeNode
    ? mixHexColors(unit.color, "#fff8ef", 0.34)
    : unit.color;
  ...
  const titleColor = isLocked
    ...
    : isLightTheme
      ? "#746250"
      : "white";
  const titleShadow = isLocked
    ? "none"
    : isLightTheme
      ? "0 1px 6px rgba(255, 249, 241, 0.72)"
        ...
        <Box
          ...
          _hover={{
            ...
            boxShadow: isLightTheme
              ? "none"
              : `0 12px 40px ${unit.color}30, 0 6px 20px rgba(0,0,0,0.4)`,
          }}
                  ...
                  <HStack justify="space-between" position="relative">
                    <HStack spacing={3}>
                      <Box
                        ...
                        boxShadow={
                          isLightTheme
                            ? "0 1px 0 rgba(255,255,255,0.6), 0 10px 18px rgba(90, 72, 48, 0.08)"
                            : lesson.isTutorial
                      ...
                      >
                        {lesson.isTutorial ? (
                          <RiTrophyLine
                            color={isLightTheme ? "#4f46e5" : "white"}
                            size={24}
                          />
                        ) : lesson.isGame ? (
                          <RiGamepadLine
                          ...
                          <RiTrophyLine
                            color={isLightTheme ? "#7c3aed" : "white"}
                            size={24}
                          />
                        ) : (
                          <RiStarFill
