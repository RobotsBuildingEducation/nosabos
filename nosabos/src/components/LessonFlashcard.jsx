...
const FLASHCARD_UI = {
  ...
  de: {
    translate_to: (languageLabel) => `Ins ${languageLabel} übersetzen`,
    show_answer: "Antwort anzeigen",
    tap_to_flip: "Tippen, um zurückzudrehen",
    answer_label: "Antwort",
    type_placeholder: "Gib deine Übersetzung ein...",
    submit: "Absenden",
    ...
    explain: "Meine Antwort erklären",
    explanation_heading: "Erklärung",
    skip: "Überspringen",
    collect: "Karte sammeln",
    collected: "Gesammelt!",
    deck_label: "Deck",
    next: "Nächste Frage",
    added_to_deck: "Zum Deck hinzugefügt",
    generating: "Karte wird erstellt...",
    connecting: "Verbindung wird hergestellt...",
    recognized: "Erkannt:",
    deck_review: "Deck-Wiederholung",
    prev: "Zurück",
    close: "Schließen",
    speech_error: "Sprachfehler",
    grading_error: "Bewertungsfehler",
    microphone_unavailable: "Mikrofon nicht verfügbar",
    could_not_explain: "Erklärung konnte nicht erstellt werden",
    loading: "Lädt",
    listen: "Anhören",
    open_keyboard: "Tastatur öffnen",
