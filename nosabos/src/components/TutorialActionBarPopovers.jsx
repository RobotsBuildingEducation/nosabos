...
const BUTTON_EXPLANATIONS = [
  ...
  },
  {
    ...
    description: {
      ...
      de: "Erledige Aufgaben außerhalb der App, um in die Sprache einzutauchen und sie zu üben.",
  ...
  },
  {
    ...
    tutorialId: "settings",
    icon: SettingsIcon,
    label: { en: "Settings", es: "Configuración", it: "Impostazioni", fr: "Paramètres", de: "Einstellungen", ja: "設定", hi: "सेटिंग्स", ar: "الإعدادات", zh: "设置" },
    description: {
      ...
      fr: "Ouvre les onglets paramètres et compte pour tes préférences, ta voix et tes détails de compte",
      de: "Öffne Einstellungen und Konto für Lernvorlieben, Stimme und Kontodetails",
  ...
  },
  {
    ...
    label: {
      ...
      pt: "Sistema de memória",
      it: "Sistema di memoria",
    ...
    description: {
      en: "The Memory System captures your mistakes as you learn and saves them for focused practice in future lessons.",
      es: "El sistema de memoria captura tus errores mientras aprendes y los guarda para practicarlos de forma específica en futuras lecciones.",
      pt: "O sistema de memória registra seus erros enquanto você aprende e os salva para uma prática focada em lições futuras.",
      it: "Il sistema di memoria cattura i tuoi errori mentre impari e li salva per esercitarti in modo mirato nelle lezioni future.",
      fr: "Le système de mémoire repère tes erreurs pendant que tu apprends et les garde pour des exercices ciblés dans les prochaines leçons.",
      de: "Das Gedächtnissystem erfasst deine Fehler beim Lernen und speichert sie für gezieltes Üben in späteren Lektionen.",
      ja: "メモリーシステムは学習中の間違いを記録し、今後のレッスンで重点的に練習できるよう保存します。",
      hi: "मेमोरी सिस्टम सीखते समय आपकी गलतियों को दर्ज करता है और आने वाले पाठों में केंद्रित अभ्यास के लिए उन्हें सहेजता है।",
      ar: "نظام الذاكرة بيلتقط أخطاءك وإنت بتتعلّم، وبيحفظها علشان تتدرّب عليها بشكل مركّز في الدروس الجاية.",
      zh: "记忆系统会记录你学习时犯的错误，并保存下来，供你在今后的课程中进行针对性练习。",
    },
    position: 3,
  },
  {
    ...
    label: { en: "Assistant", es: "Asistente", it: "Assistente", fr: "Assistant", de: "Assistent", ja: "アシスタント", hi: "सहायक", ar: "المساعد", zh: "助手" },
    description: {
      ...
      de: "Erhalte sofort Hilfe und Antworten von unserem Lernassistenten",
