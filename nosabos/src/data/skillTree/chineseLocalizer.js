...
const TEXT_TRANSLATIONS = {
  ...
  "numbers 11-30": "数字 11-30",
  "count from eleven to thirty": "从十一数到三十",
  "counting from eleven to thirty": "从十一数到三十",
  "learn to count from eleven to thirty": "学习从十一数到三十",
  "numbers 11-30 quiz": "数字 11-30 测验",
  "test your knowledge of numbers 11-30": "测试你对数字 11-30 的掌握",
  "zero to five": "零到五",
  "six to ten": "六到十",
  ...
  "apply artistic language skills": "运用艺术语言技巧",
