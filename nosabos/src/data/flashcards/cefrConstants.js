/**
 * CEFR metadata, colors, and level counts.
 * Kept standalone to avoid pulling large localization dictionaries into core bundles.
 */
...
export const TOTAL_FLASHCARDS = Object.values(CEFR_LEVEL_COUNTS).reduce(
  (a, b) => a + b,
  0,
);
