...
export const translations = {
  en: {
    ...
    flashcard_session_default: "Flashcard session",
    flashcard_session_progress: "Card {current} of {total}",
    flashcard_training_title: "Train the cards that matter right now",
    flashcard_training_subtitle:
      "Review what is due, pressure-test weak memories, and keep unlocking new phrases in short, focused rounds.",
    flashcard_due_now_stat: "{count} due now",
    flashcard_weak_stat: "{count} weak cards",
    flashcard_new_stat: "{count} new cards",
    flashcard_session_smart_title: "Smart review",
    flashcard_session_smart_desc:
      "Clear your due cards first, then mix in weak spots and a little fresh material.",
    flashcard_session_smart_cta: "Start smart review",
    flashcard_session_challenge_title: "Challenge round",
    flashcard_session_challenge_desc:
      "Hit the cards that keep slipping so recall feels active instead of passive.",
    flashcard_session_challenge_cta: "Start challenge",
    flashcard_session_learn_title: "Unlock new cards",
    flashcard_session_learn_desc:
      "Push forward through the next phrases without losing the review rhythm.",
    flashcard_session_learn_cta: "Learn new cards",
    flashcard_session_due_count: "{count} cards are ready for review",
    flashcard_session_due_empty: "No review debt right now",
    flashcard_session_weak_count: "{count} cards need another fight",
    flashcard_session_weak_empty: "Your recent cards are holding up well",
    flashcard_session_new_count: "{count} cards are still locked in the queue",
    flashcard_session_new_empty: "No new cards left in this level",
    flashcard_session_single_title: "Focused rep",
    flashcard_session_single_desc: "Stay on the next unlock and keep the streak moving.",
    flashcard_continue_title: "Continue the path",
    flashcard_continue_desc:
      "The next unlock is still visible, but the long strip is compressed so you can focus.",
    flashcard_remaining_count: "{count} still to learn",
    flashcard_mastered_title: "Recently stabilized",
    flashcard_mastered_desc:
      "Completed cards now stay in a review pool instead of getting thrown back into the main line.",
    flashcard_scheduled_count: "{count} scheduled later",
    flashcard_mastered_badge: "Review pool active",
    flashcard_xp_level_badge: "Level {level}",
  ...
  es: {
    ...
    flashcard_session_default: "Sesión de tarjetas",
    flashcard_session_progress: "Tarjeta {current} de {total}",
    flashcard_training_title: "Entrena las tarjetas que importan ahora",
    flashcard_training_subtitle:
      "Repasa lo que ya toca, presiona los recuerdos débiles y sigue desbloqueando frases nuevas en rondas cortas.",
    flashcard_due_now_stat: "{count} pendientes",
    flashcard_weak_stat: "{count} débiles",
    flashcard_new_stat: "{count} nuevas",
    flashcard_session_smart_title: "Repaso inteligente",
    flashcard_session_smart_desc:
      "Limpia primero las tarjetas vencidas y luego mezcla puntos débiles con material nuevo.",
    flashcard_session_smart_cta: "Iniciar repaso",
    flashcard_session_challenge_title: "Ronda desafío",
    flashcard_session_challenge_desc:
      "Ataca las tarjetas que se siguen escapando para que el recuerdo se sienta activo.",
    flashcard_session_challenge_cta: "Iniciar desafío",
    flashcard_session_learn_title: "Desbloquear nuevas",
    flashcard_session_learn_desc:
      "Avanza por las siguientes frases sin perder el ritmo de repaso.",
    flashcard_session_learn_cta: "Aprender nuevas",
    flashcard_session_due_count: "{count} tarjetas listas para repaso",
    flashcard_session_due_empty: "No tienes deuda de repaso ahora",
    flashcard_session_weak_count: "{count} tarjetas necesitan otra vuelta",
    flashcard_session_weak_empty: "Tus tarjetas recientes van bien",
    flashcard_session_new_count: "{count} tarjetas siguen en la fila",
    flashcard_session_new_empty: "No quedan tarjetas nuevas en este nivel",
    flashcard_session_single_title: "Repetición enfocada",
    flashcard_session_single_desc: "Concéntrate en el siguiente desbloqueo y mantén la racha.",
    flashcard_continue_title: "Continúa la ruta",
    flashcard_continue_desc:
      "El siguiente desbloqueo sigue visible, pero comprimimos la fila para que te enfoques.",
    flashcard_remaining_count: "{count} por aprender",
    flashcard_mastered_title: "Recientemente estabilizadas",
    flashcard_mastered_desc:
      "Las tarjetas completadas ahora viven en un pool de repaso en vez de volver a la fila principal.",
    flashcard_scheduled_count: "{count} programadas para después",
    flashcard_mastered_badge: "Pool de repaso activo",
    flashcard_xp_level_badge: "Nivel {level}",
