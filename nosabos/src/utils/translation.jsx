...
export const translations = {
  en: {
    ...
    srs_due_label: "Due",
    srs_learning_label: "Learning",
    srs_new_label: "New",
    srs_learning: "Learning",
    srs_review: "Review",
    srs_new: "New",
    srs_study_now: "Study Now ({count})",
    srs_all_caught_up: "All caught up!",
    srs_come_back_later: "No cards due right now. Come back later for reviews!",
    srs_up_next: "Up next",
    srs_more_cards: "+{count} more cards",
    srs_session_complete: "Session Complete!",
    srs_session_stats: "Reviewed {reviewed} cards — {correct} correct",
    srs_accuracy: "accuracy",
    srs_back_to_dashboard: "Back to Dashboard",
    srs_end_session: "End Session",
    srs_how_was_it: "How well did you remember?",
    srs_again: "Again",
    srs_hard: "Hard",
    srs_good: "Good",
    srs_easy: "Easy",
  ...
  es: {
    ...
    // SRS (Spaced Repetition) strings
    srs_due_label: "Pendientes",
    srs_learning_label: "Aprendiendo",
    srs_new_label: "Nuevas",
    srs_learning: "Aprendiendo",
    srs_review: "Repasar",
    srs_new: "Nueva",
    srs_study_now: "Estudiar Ahora ({count})",
    srs_all_caught_up: "¡Todo al día!",
    srs_come_back_later: "No hay tarjetas pendientes. ¡Vuelve más tarde para repasar!",
    srs_up_next: "Siguiente",
    srs_more_cards: "+{count} tarjetas más",
    srs_session_complete: "¡Sesión Completa!",
    srs_session_stats: "Repasaste {reviewed} tarjetas — {correct} correctas",
    srs_accuracy: "precisión",
    srs_back_to_dashboard: "Volver al Panel",
    srs_end_session: "Terminar Sesión",
    srs_how_was_it: "¿Qué tan bien lo recordaste?",
    srs_again: "Otra vez",
    srs_hard: "Difícil",
    srs_good: "Bien",
    srs_easy: "Fácil",
