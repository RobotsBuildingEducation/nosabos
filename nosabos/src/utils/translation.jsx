...
export const translations = {
  en: {
    ...
    ra_vad_label: "How long to wait to respond to your speech",
    ...
    onboarding_voice_cedar: "Cedar",
    onboarding_voice_marin: "Marin",
    onboarding_voice_sage: "Sage",
    onboarding_voice_shimmer: "Shimmer",
    onboarding_voice_verse: "Verse",
    onboarding_voice_alloy_description: "Balanced and neutral",
    onboarding_voice_coral_description: "Bright and friendly",
    onboarding_voice_ash_description: "Calm and steady",
    onboarding_voice_shimmer_description: "Soft and upbeat",
    onboarding_voice_ballad_description: "Smooth and dramatic",
    onboarding_voice_sage_description: "Warm and composed",
    onboarding_voice_cedar_description: "Deep and grounded",
    onboarding_voice_marin_description: "Cheerful and warm",
    onboarding_voice_echo_description: "Crisp and energetic",
    onboarding_voice_verse_description: "Expressive and clear",
    ...
    app_install_step3: "Press 'Share' and expand the window",
    app_install_step4: 'Press {home} "Add to Home Screen" or {app} "Install App"',
    app_install_step5: "The app is now installed on your device!",
    app_close: "Close",
    ...
    tutor_volume_label: "Tutor volume",
  ...
  es: {
    ...
    app_mode_phonics: "Fonética",
    app_mode_path: "Lecciones",
    ...
    app_install_step3: "Pulsa 'Compartir' y expande la ventana",
    app_install_step4: 'Pulsa {home} "Añadir a pantalla de inicio" o {app} "Instalar app"',
    app_install_step5: "¡La app ya está instalada en tu dispositivo!",
    app_close: "Cerrar",
    ...
    onboarding_voice_alloy: "Aleación",
    onboarding_voice_ash: "Ceniza",
    onboarding_voice_ballad: "Balada",
    onboarding_voice_coral: "Coral",
    onboarding_voice_echo: "Eco",
    onboarding_voice_cedar: "Cedro",
    onboarding_voice_marin: "Marina",
    onboarding_voice_sage: "Sabia",
    onboarding_voice_shimmer: "Brillo",
    onboarding_voice_verse: "Verso",
    onboarding_voice_alloy_description: "Equilibrada y neutral",
    onboarding_voice_coral_description: "Brillante y amable",
    onboarding_voice_ash_description: "Tranquila y constante",
    onboarding_voice_shimmer_description: "Suave y animada",
    onboarding_voice_ballad_description: "Fluida y dramática",
    onboarding_voice_sage_description: "Cálida y serena",
    onboarding_voice_cedar_description: "Profunda y sólida",
    onboarding_voice_marin_description: "Alegre y cálida",
    onboarding_voice_echo_description: "Nítida y enérgica",
    onboarding_voice_verse_description: "Expresiva y clara",
    ...
    onboarding_practice_language_desc:
      "El idioma que quieres aprender y practicar",
    onboarding_section_difficulty_support: "Dificultad y apoyo de idioma",
    onboarding_section_voice_persona: "Voz y personalidad",
    onboarding_voice_title: "Voz",
    onboarding_voice_desc: "Elige la voz y el estilo de tu coach.",
    onboarding_vad_title: "Cuánto esperar para responder a tu voz",
    onboarding_vad_explanation:
    ...
    tutor_volume_label: "Volumen del tutor",
...
translations.it = {
  ...
  language_yua: "Maya yucateco",
  onboarding_voice_alloy: "Lega",
  onboarding_voice_ash: "Cenere",
  onboarding_voice_ballad: "Ballata",
  onboarding_voice_coral: "Corallo",
  onboarding_voice_echo: "Eco",
  onboarding_voice_cedar: "Cedro",
  onboarding_voice_marin: "Marina",
  onboarding_voice_sage: "Saggia",
  onboarding_voice_shimmer: "Scintillio",
  onboarding_voice_verse: "Verso",
  onboarding_voice_alloy_description: "Equilibrata e neutra",
  onboarding_voice_coral_description: "Vivace e amichevole",
  onboarding_voice_ash_description: "Calma e stabile",
  onboarding_voice_shimmer_description: "Morbida e allegra",
  onboarding_voice_ballad_description: "Fluida e teatrale",
  onboarding_voice_sage_description: "Calda e composta",
  onboarding_voice_cedar_description: "Profonda e solida",
  onboarding_voice_marin_description: "Solare e calda",
  onboarding_voice_echo_description: "Nitida ed energica",
  onboarding_voice_verse_description: "Espressiva e chiara",
  ...
  onboarding_practice_language_desc:
    "La lingua che vuoi imparare e praticare",
  ...
  onboarding_voice_title: "Voce",
  onboarding_voice_desc: "Scegli la voce e lo stile del tuo coach.",
  onboarding_vad_title: "Quanto aspettare prima di rispondere alla tua voce",
  onboarding_vad_explanation:
  ...
  app_mode_alphabet: "Alfabeto",
  app_mode_phonics: "Fonetica",
  app_mode_path: "Lezioni",
  ...
  app_install_step3: "Premi 'Condividi' ed espandi la finestra",
  app_install_step4: 'Premi {home} "Aggiungi a Home" o {app} "Installa app"',
  app_install_step5: "L'app è ora installata sul tuo dispositivo!",
  app_close: "Chiudi",
  app_sign_out: "Esci",
  ...
  sound_volume_label: "Volume",
  tutor_volume_label: "Volume del tutor",
  theme_mode_label: "Tema",
  theme_mode_description:
...
translations.fr = {
  ...
  onboarding_voice_alloy: "Alliage",
  onboarding_voice_ash: "Cendre",
  onboarding_voice_ballad: "Ballade",
  onboarding_voice_coral: "Corail",
  onboarding_voice_echo: "Echo",
  onboarding_voice_cedar: "Cedre",
  onboarding_voice_marin: "Marine",
  onboarding_voice_sage: "Sage",
  onboarding_voice_shimmer: "Scintillement",
  onboarding_voice_verse: "Vers",
  onboarding_voice_alloy_description: "Equilibree et neutre",
  onboarding_voice_coral_description: "Claire et amicale",
  onboarding_voice_ash_description: "Calme et stable",
  onboarding_voice_shimmer_description: "Douce et dynamique",
  onboarding_voice_ballad_description: "Fluide et dramatique",
  onboarding_voice_sage_description: "Chaleureuse et posee",
  onboarding_voice_cedar_description: "Profonde et ancree",
  onboarding_voice_marin_description: "Enjouee et chaleureuse",
  onboarding_voice_echo_description: "Nette et energique",
  onboarding_voice_verse_description: "Expressive et claire",
  ...
  onboarding_practice_language_desc:
    "La langue que tu veux apprendre et pratiquer",
  ...
  onboarding_voice_title: "Voix",
  onboarding_voice_desc: "Choisis la voix et le style de ton coach.",
  onboarding_vad_title: "Combien de temps attendre avant de repondre a ta voix",
  onboarding_vad_explanation:
  ...
  app_mode_menu: "Mode",
  app_mode_alphabet: "Alphabet",
  app_mode_phonics: "Phonétique",
  app_mode_path: "Leçons",
  app_mode_cards: "Cartes",
  app_mode_conversation: "Conversation",
  app_mode_tutor: "Tuteur",
  ...
  app_install_step3: "Appuie sur 'Partager' et agrandis la fenêtre",
  app_install_step4: 'Appuie sur {home} "Ajouter à l\'écran d\'accueil" ou {app} "Installer l\'app"',
  app_install_step5: "L'application est maintenant installée sur ton appareil !",
  app_close: "Fermer",
  ...
  sound_volume_label: "Volume",
  tutor_volume_label: "Volume du tuteur",
  theme_mode_label: "Theme",
  theme_mode_description:
...
translations.ja = {
  ...
  onboarding_voice_alloy: "アロイ",
  onboarding_voice_ash: "アッシュ",
  onboarding_voice_ballad: "バラード",
  onboarding_voice_coral: "コーラル",
  onboarding_voice_echo: "エコー",
  onboarding_voice_cedar: "シダー",
  onboarding_voice_marin: "マリン",
  onboarding_voice_sage: "セージ",
  onboarding_voice_shimmer: "シマー",
  onboarding_voice_verse: "ヴァース",
  onboarding_voice_alloy_description: "バランスのよい自然な声",
  onboarding_voice_coral_description: "明るく親しみやすい声",
  onboarding_voice_ash_description: "落ち着いた安定感のある声",
  onboarding_voice_shimmer_description: "やわらかく軽快な声",
  onboarding_voice_ballad_description: "なめらかでドラマチックな声",
  onboarding_voice_sage_description: "温かく落ち着いた声",
  onboarding_voice_cedar_description: "深く安定した声",
  onboarding_voice_marin_description: "明るく温かい声",
  onboarding_voice_echo_description: "歯切れよくエネルギッシュな声",
  onboarding_voice_verse_description: "表現豊かで明瞭な声",
  ...
  onboarding_voice_title: "音声",
  onboarding_voice_desc: "コーチの音声とスタイルを選びます。",
  onboarding_vad_title: "あなたの音声に応答するまで待つ時間",
  onboarding_vad_explanation:
  ...
  app_mode_phonics: "フォニックス",
  app_mode_path: "レッスン",
  app_mode_cards: "カード",
  app_mode_conversation: "会話",
  app_mode_tutor: "チューター",
  app_lang_en: "英語",
  app_lang_es: "スペイン語",
  app_install_title: "アプリをインストール",
  app_install_step1: "共有ボタンをタップします。",
  app_install_step2: "「ホーム画面に追加」を選びます。",
  app_install_step3: "「共有」を押してウィンドウを広げます",
  app_install_step4: "{home} 「ホーム画面に追加」または {app} 「アプリをインストール」を押します",
  app_install_step5: "アプリがデバイスにインストールされました！",
