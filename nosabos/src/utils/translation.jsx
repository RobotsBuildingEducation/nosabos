...
export const translations = {
  en: {
    ...
    history_speech_instructions:
      "Try reading the paragraph above out loud or type what you read. You'll get feedback on your reading!",
    history_speech_start_mic: "Start reading",
    history_speech_stop_mic: "Stop",
    history_speech_placeholder: "Type or speak what you read...",
    history_speech_submit: "Get feedback",
  ...
  es: {
    ...
    history_speech_instructions:
      "Intenta leer el párrafo de arriba en voz alta o escribe lo que leíste. ¡Recibirás retroalimentación!",
    history_speech_start_mic: "Empezar a leer",
    history_speech_stop_mic: "Detener",
    history_speech_placeholder: "Escribe o habla lo que leíste...",
    history_speech_submit: "Obtener retroalimentación",
