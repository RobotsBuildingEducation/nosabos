...
export const translations = {
  en: {
    ...
    quiz_passing_required: "80% to pass",
    ...
    quiz_passed_message: "You've successfully completed this quiz. You can now move on to the next unit.",
    quiz_try_again_title: "Keep Practicing",
    quiz_failed_message: "You need at least 80% to pass. Review the material and try again!",
  ...
  es: {
    ...
    quiz_passing_required: "80% para aprobar",
    quiz_passed: "¡Examen Aprobado!",
    quiz_failed: "Examen No Aprobado",
    quiz_score: "Puntuación",
    quiz_correct_answers: "Respuestas Correctas",
    quiz_passing_score: "Puntuación para Aprobar",
    quiz_congratulations: "¡Felicidades!",
    quiz_passed_message: "Has completado exitosamente este examen. Ahora puedes pasar a la siguiente unidad.",
    quiz_try_again_title: "Sigue Practicando",
    quiz_failed_message: "Necesitas al menos 80% para aprobar. ¡Repasa el material e inténtalo de nuevo!",
    quiz_retry: "Reintentar Examen",
    quiz_close: "Cerrar",
    tabs_quiz: "Examen",
